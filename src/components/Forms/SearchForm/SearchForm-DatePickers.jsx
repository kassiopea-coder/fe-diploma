...
export default function DatePickers({ formView }) {
   ...
   const Input = forwardRef(({ value, onClick }, ref) => (
      <input
         className={`search-form_field search-form_field--date ${
   ...
   return (
      <div className={`search-form_fieldset ${formView}_fieldset`}>
         <p className={`search-form_title ${formView}-title`}>Дата</p>
